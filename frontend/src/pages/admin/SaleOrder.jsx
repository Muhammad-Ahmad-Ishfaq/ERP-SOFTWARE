...
import AddSaleOrderModal from '@/components/Sale Order/AddSaleOrderModal';
...
const SaleOrder = () => {
  ...
  const handleDelete = async () => {
    if (!deleteId) return;
    try {
      await api.delete(`/sale-orders/sale-orders/${deleteId}/`);
    ...
    <div>
                ...
                <tr>
                  <td colSpan="7">
                    <EmptyState
                      ...
                      description="Create your first sale order to track customer orders."
                ...
                filtered.map((p) => {
                  ...
                  return (
                    <tr key={p.id} className="hover:bg-gray-50/50 transition-colors">
                      ...
                      <td className="px-5 py-3.5 text-sm text-gray-900">{p.customer_name || '-'}</td>
      ...
      <AlertDialog open={deleteDialog} onOpenChange={setDeleteDialog}>
        <AlertDialogContent className="max-w-md">
          <AlertDialogHeader>
            <AlertDialogTitle className="text-lg font-semibold text-gray-900">Delete Sale Order</AlertDialogTitle>
            <AlertDialogDescription className="text-sm text-gray-500">
              This sale order will be permanently removed. This action cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
