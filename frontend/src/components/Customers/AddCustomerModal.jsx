...
const AddCustomerModal = ({
  open,
  onOpenChange,
  customerForm: externalForm,
  setCustomerForm: externalSetForm,
  editingCustomerId,
  onSave,
  existingCustomers = [],
}) => {
  ...
  useEffect(() => {
    if (open) {
      if (editingCustomerId) {
        ...
        // New entry: compute next code from existing customers (debtors)
        const maxCode = existingCustomers.reduce((max, c) => Math.max(max, c.code), 0);
  ...
  }, [open, externalForm, editingCustomerId, existingCustomers]);
  ...
  const handleSave = async () => {
    ...
    const payload = {
      ...
      sub: 'debtor',                     // always debtor for customers
    ...
    try {
      let response;
      if (editingCustomerId) {
        response = await api.put(`/accounting/parties/${editingCustomerId}/`, payload);
      ...
      >
        ...
        <form className="flex-1 overflow-y-auto px-4 py-2 space-y-5">
          ...
          <div className="space-y-1.5">
            <Label htmlFor="customer-code" className="text-sm font-medium text-gray-700 flex items-center gap-1.5">
              Code
          ...
          {/* Name */}
          <div className="space-y-1.5">
            <Label htmlFor="customer-name" className="text-sm font-medium text-gray-700 flex items-center gap-1.5">
              Name
              <span className="text-red-500 ml-1">*</span>
            </Label>
            <div className="relative">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-1.5">
              <Label htmlFor="customer-phone" className="text-sm font-medium text-gray-700 flex items-center gap-1.5">
                Phone
              </Label>
              <div className="relative">
                <Input
            ...
            <div className="space-y-1.5">
              <Label htmlFor="customer-cell" className="text-sm font-medium text-gray-700 flex items-center gap-1.5">
                Cell
              </Label>
              <div className="relative">
                <Input
          ...
          {/* Address */}
          <div className="space-y-1.5">
            <Label htmlFor="customer-address" className="text-sm font-medium text-gray-700 flex items-center gap-1.5">
              Address
            </Label>
            <div className="relative">
              <Input
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-1.5">
              <Label htmlFor="customer-ntn" className="text-sm font-medium text-gray-700 flex items-center gap-1.5">
                NTN
              </Label>
              <div className="relative">
                <Input
            ...
            <div className="space-y-1.5">
              <Label htmlFor="customer-gst" className="text-sm font-medium text-gray-700 flex items-center gap-1.5">
                GST No
              </Label>
              <div className="relative">
                <Input
            ...
            >
              {isLoading ? (
                <>
                  ...
                  {editingCustomerId ? 'Updating...' : 'Saving...'}
                </>
              ) : (
